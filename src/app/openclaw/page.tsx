  ...
  return (
    <main className="min-h-screen bg-[#0e0e10] text-white">
      ...
      <section className="relative overflow-hidden px-4 py-20 sm:py-32">
        ...
        <div className="absolute left-0 top-0 h-96 w-96 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[--color-accent] opacity-20 blur-3xl" />
        <div className="absolute bottom-0 right-0 h-96 w-96 translate-x-1/2 translate-y-1/2 rounded-full bg-[--color-accent] opacity-10 blur-3xl" />
        
        <div className="relative mx-auto max-w-6xl">
          {/* Pill badge */}
          <div className="mb-6 flex justify-center">
            <span className="inline-flex items-center gap-2 rounded-full border border-[--color-accent]/30 bg-[--color-accent]/10 px-4 py-1.5 text-sm text-[--color-accent]">
          ...
          <h1 className="mb-6 text-center font-[family-name:var(--font-playfair)] text-5xl sm:text-6xl lg:text-7xl leading-tight">
            ...
            <br />
            <span className="text-[--color-muted]">Done For You</span>
          </h1>

          {/* Description */}
          <p className="mx-auto mb-8 max-w-3xl text-center text-lg text-[--color-muted] sm:text-xl">
      ...
      <section className="px-4 py-16">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mb-12 text-center text-[--color-muted]">
            Not demos or side projects — these are production AI employees handling real work daily.
          </p>

          <div className="grid gap-6 sm:grid-cols-2">
            {/* Deployment 1 */}
            <div className="rounded-xl border-l-4 border-[--color-accent] bg-[--color-surface] p-6">
              <div className="mb-3 text-3xl">🏥</div>
              <h3 className="mb-2 text-xl font-semibold">Healthcare Agency</h3>
              <p className="mb-3 text-sm text-[--color-accent]">55+ staff</p>
              <p className="text-[--color-muted]">
            ...
            <div className="rounded-xl border-l-4 border-[--color-accent] bg-[--color-surface] p-6">
              ...
              <p className="mb-3 text-sm text-[--color-accent]">Growing startup</p>
              <p className="text-[--color-muted]">
            ...
            <div className="rounded-xl border-l-4 border-[--color-accent] bg-[--color-surface] p-6">
              ...
              <p className="mb-3 text-sm text-[--color-accent]">Solo practitioner</p>
              <p className="text-[--color-muted]">
            ...
            <div className="rounded-xl border-l-4 border-[--color-accent] bg-[--color-surface] p-6">
              ...
              <p className="mb-3 text-sm text-[--color-accent]">US-based</p>
              <p className="text-[--color-muted]">
            ...
            {/* Deployment 5 */}
            <div className="col-span-full rounded-xl border-l-4 border-[--color-accent] bg-[--color-surface] p-6 sm:col-span-1">
              <div className="mb-3 text-3xl">📊</div>
              <h3 className="mb-2 text-xl font-semibold">Business Strategy</h3>
              <p className="mb-3 text-sm text-[--color-accent]">Internal deployment</p>
              <p className="text-[--color-muted]">
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-6">
              <div className="flex-shrink-0">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[--color-accent] text-xl font-bold">
                  01
                </div>
              </div>
              <div>
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mb-8 grid gap-8 sm:grid-cols-2">
            ...
            <div className="rounded-xl border border-[--color-border] bg-[--color-surface] p-8 text-center">
              <div className="mb-2 font-[family-name:var(--font-playfair)] text-5xl font-bold text-[--color-accent]">
                From £497
              </div>
          ...
          <p className="mb-8 text-center text-sm text-[--color-muted]">
