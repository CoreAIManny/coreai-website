    ...
    <section className="border-t border-gray-200">
      <div className="mx-auto max-w-4xl px-4 py-20">
        <div className="rounded-2xl border border-yellow-200 bg-yellow-50 p-8 sm:p-12">
          ...
          <blockquote className="mt-6 text-lg leading-relaxed text-text sm:text-xl">
        ...
        <div className="mt-8 rounded-2xl border border-accent/20 bg-accent/5 p-8 text-center">
          ...
          <a
            href="/book-demo"
            className="mt-4 inline-block rounded-full bg-accent px-6 py-2.5 text-sm font-medium text-white transition hover:bg-accent-hover"
          >
